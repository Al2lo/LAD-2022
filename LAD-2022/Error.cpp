...
namespace Error
{
	...
	*/
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(300, "Семантическая ошибка: Неверно указан тип"),
		...
		ERROR_ENTRY(308, "Семантическая ошибка: Количество ожидаемыех параметров функции и передаваемых параметров не совпадают"),
		...
		ERROR_ENTRY(317, "Семантическая ошибка: Недопустимое символьное выражение справа от знака \'=\'"),
		ERROR_ENTRY(318, "Семантическая ошибка: Неверное условное выражение"),
		ERROR_ENTRY(319, "Семантическая ошибка: Деление на ноль"),
		ERROR_ENTRY(320, "Семантическая ошибка: Присвоение значения не входящего в диапазон данного типа"),
		ERROR_ENTRY(321,"Семантическая ошибка: После функции main выполнять какие-либо действия"),
		ERROR_ENTRY(322,  "Семантическая ошибка: Неверное арифметическое выражение"),
		ERROR_ENTRY_NODEF(323),ERROR_ENTRY_NODEF(324),ERROR_ENTRY_NODEF(325),
		...
		ERROR_ENTRY(612, "Синтаксическая ошибка: Неверное возвращаемое значение. Ожидаются только идентификаторы/литералы"),
		ERROR_ENTRY(613, "Синтаксическая ошибка: Ошибка в арифметическом выражении"),
		ERROR_ENTRY(614, "Синтаксическая ошибка: Отсутствие идентификатора"),
