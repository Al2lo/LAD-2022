...
#define TS(n) Rule::Chain::T(n)
	...
	Greibach greibach(
		...
		TS('$'),
		16,
		Rule(NS('S'), GRB_ERROR_SERIES,	
			3,
			Rule::Chain(6, TS('p'), TS('f'), NS('i'), NS('P'), NS('G'), NS('S')),
			Rule::Chain(4, TS('m'), TS('{'), NS('K'),TS('}')),
			Rule::Chain(6, TS('t'), TS('f'), TS('i'), NS('P'), NS('T'), NS('S'))
		),

		Rule(NS('P'), GRB_ERROR_SERIES + 1,
			2,
		...
		Rule(NS('K'), GRB_ERROR_SERIES + 14, 14,				
			...
			Rule::Chain(7, TS('~'), TS('$'), NS('C'), TS('$'), TS('?'), NS('R'), NS('K')),	
			...
			Rule::Chain(2, TS('^'), TS(';')),							
			Rule::Chain(6, TS('~'), TS('$'), NS('C'), TS('$'), TS('?'), NS('R')),			
		...
		Rule(NS('R'), GRB_ERROR_SERIES + 7, 5,					
			Rule::Chain(3, TS('e'), NS('Y'), TS('?')),
			Rule::Chain(3, TS('w'), NS('Y'), TS('?')),
			Rule::Chain(3, TS('c'), NS('Y'), TS('?')),
			Rule::Chain(5, TS('e'), NS('Y'), TS('w'), NS('Y'), TS('?')),
			Rule::Chain(5, TS('w'), NS('Y'), TS('e'), NS('Y'), TS('?'))
		),
